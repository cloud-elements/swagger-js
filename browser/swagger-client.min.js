...
"use strict";var SwaggerHttp=require("./http"),_={isObject:require("lodash-compat/lang/isObject"),cloneDeep:require("lodash-compat/lang/cloneDeep"),isArray:require("lodash-compat/lang/isArray")},Resolver=module.exports=function(){};Resolver.prototype.processAllOf=function(e,r,o,i,t,s){var n,l,f;o["x-resolved-from"]=["#/definitions/"+r];var a=o.allOf;for(a.sort(function(e,r){return e.$ref&&r.$ref?0:e.$ref?-1:1}),n=0;n<a.length;n++)f=a[n],l="/definitions/"+r+"/allOf",this.resolveInline(e,s,f,i,t,l)},Resolver.prototype.resolve=function(e,r,o,i){this.spec=e;var t,s,n=r,l=o,f=i,a={};"function"==typeof r&&(n=null,l=r,f=o);var p=n;this.scope=f||this,this.iteration=this.iteration||0,this.scope.options&&this.scope.options.requestInterceptor&&(a.requestInterceptor=this.scope.options.requestInterceptor),this.scope.options&&this.scope.options.responseInterceptor&&(a.responseInterceptor=this.scope.options.responseInterceptor);var h,v,c,d,u=0,g={},y={},O=[];e.definitions=e.definitions||{};for(h in e.definitions){var m=e.definitions[h];for(d in m.properties)c=m.properties[d],_.isArray(c.allOf)?this.processAllOf(n,h,c,O,y,e):this.resolveTo(n,c,O,"/definitions");m.allOf&&this.processAllOf(n,h,m,O,y,e)}for(h in e.paths){var x,b,A;v=e.paths[h];for(x in v)if("$ref"===x)t="/paths"+h,this.resolveInline(n,e,v,O,y,t);else{b=v[x];var k=v.parameters||[],j=b.parameters||[];for(s in k){var R=k[s];j.unshift(R)}"parameters"!==x&&_.isObject(b)&&(b.parameters=b.parameters||j);for(s in j){var R=j[s];if(t="/paths"+h+"/"+x+"/parameters","body"===R["in"]&&R.schema)if(_.isArray(R.schema.allOf)){for(var w="inline_model",h=w,$=!1,q=0;!$;){if("undefined"==typeof e.definitions[h]){$=!0;break}h=w+"_"+q,q++}e.definitions[h]={allOf:R.schema.allOf},delete R.schema.allOf,R.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,R.schema,O,t);R.$ref&&this.resolveInline(n,e,R,O,y,R.$ref)}for(A in b.responses){var I=b.responses[A];if(t="/paths"+h+"/"+x+"/responses/"+A,_.isObject(I)&&(I.$ref&&this.resolveInline(n,e,I,O,y,t),I.schema)){var T=I;if(_.isArray(T.schema.allOf)){for(var w="inline_model",h=w,$=!1,q=0;!$;){if("undefined"==typeof e.definitions[h]){$=!0;break}h=w+"_"+q,q++}e.definitions[h]={allOf:T.schema.allOf},delete T.schema.allOf,delete T.schema.type,T.schema.$ref="#/definitions/"+h,this.processAllOf(n,h,e.definitions[h],O,y,e)}else this.resolveTo(n,I.schema,O,t)}}}v.parameters=[]}var D,H=0,S=[],P=O;for(s=0;s<P.length;s++){var z=P[s];if(n===z.root){if("ref"===z.resolveAs){var N,U=((z.root||"")+"/"+z.key).split("/"),E=[],J="";if(z.key.indexOf("../")>=0){for(var Q=0;Q<U.length;Q++)".."===U[Q]?E=E.slice(0,E.length-1):E.push(U[Q]);for(N=0;N<E.length;N++)N>0&&(J+="/"),J+=E[N];z.root=J,S.push(z)}else if(D=z.key.split("#"),2===D.length){(0===D[0].indexOf("http://")||0===D[0].indexOf("https://"))&&(z.root=D[0]),t=D[1].split("/");var B,C=e;for(N=0;N<t.length;N++){var F=t[N];if(""!==F){if(C=C[F],"undefined"==typeof C){B=null;break}B=C}}null===B&&S.push(z)}}else if("inline"===z.resolveAs){if(z.key&&-1===z.key.indexOf("#")&&"/"!==z.key.charAt(0)){for(D=z.root.split("/"),t="",s=0;s<D.length-1;s++)t+=D[s]+"/";t+=z.key,z.root=t,z.location=""}S.push(z)}}else S.push(z)}H=S.length;for(var G=0;G<S.length;G++)!function(e,r,o){if(null===e.root||e.root===n)o.resolveItem(r,p,O,g,y,e),u+=1,u===H&&o.finish(r,n,O,g,y,l,!0);else{var i={};i=null==o.scope.swaggerRequestHeaders||"string"==typeof o.scope.swaggerRequestHeaders?{accept:o.scope.swaggerRequestHeaders||"application/json"}:o.scope.swaggerRequestHeaders;var t={useJQuery:!1,url:e.root,method:"get",headers:i,on:{error:function(i){u+=1,y[e.key]={root:e.root,location:e.location},u===H&&o.finish(r,p,O,g,y,l)},response:function(i){var t=i.obj;o.resolveItem(t,e.root,O,g,y,e),u+=1,u===H&&o.finish(r,p,O,g,y,l)}}};f&&f.clientAuthorizations&&f.clientAuthorizations.apply(t),(new SwaggerHttp).execute(t,a)}}(S[G],e,this);0===Object.keys(S).length&&this.finish(e,p,O,g,y,l)},Resolver.prototype.resolveItem=function(e,r,o,i,t,s){var n=s.location,l=e,f=n.split("/");if(""!==n)for(var a=0;a<f.length;a++){var p=f[a];if(-1!==p.indexOf("~1")&&(p=f[a].replace(/~0/g,"~").replace(/~1/g,"/"),"/"!==p.charAt(0)&&(p="/"+p)),"undefined"==typeof l||null===l)break;if(""===p&&a===f.length-1&&f.length>1){l=null;break}p.length>0&&(l=l[p])}var h=s.key;f=s.key.split("/");var v=f[f.length-1];v.indexOf("#")>=0&&(v=v.split("#")[1]),null!==l&&"undefined"!=typeof l?i[h]={name:v,obj:l,key:s.key,root:s.root}:t[h]={root:s.root,location:s.location}},Resolver.prototype.finish=function(e,r,o,i,t,s,n){var l;for(l in o){var f=o[l],a=f.key,p=i[a];if(p)if(e.definitions=e.definitions||{},"ref"===f.resolveAs){if(n!==!0)for(a in p.obj)var h=this.retainRoot(p.obj[a],f.root);e.definitions[p.name]=p.obj,f.obj.$ref="#/definitions/"+p.name}else if("inline"===f.resolveAs){var v=f.obj;v["x-resolved-from"]=[f.key],delete v.$ref;for(a in p.obj){var h=p.obj[a];n!==!0&&(h=this.retainRoot(p.obj[a],f.root)),v[a]=h}}}var c=this.countUnresolvedRefs(e);0===c||this.iteration>5?(this.resolveAllOf(e.definitions),s.call(this.scope,e,t)):(this.iteration+=1,this.resolve(e,r,s,this.scope))},Resolver.prototype.countUnresolvedRefs=function(e){var r,o=this.getRefs(e),i=[],t=[];for(r in o)0===r.indexOf("#")?i.push(r.substring(1)):t.push(r);for(r=0;r<i.length;r++)for(var s=i[r],n=s.split("/"),l=e,f=0;f<n.length;f++){var a=n[f];if(""!==a&&(l=l[a],"undefined"==typeof l)){t.push(s);break}}return t.length},Resolver.prototype.getRefs=function(e,r){r=r||e;var o={};for(var i in r)if(r.hasOwnProperty(i)){var t=r[i];if("$ref"===i&&"string"==typeof t)o[t]=null;else if(_.isObject(t)){var s=this.getRefs(t);for(var n in s)o[n]=null}}return o},Resolver.prototype.retainRoot=function(e,r){for(var o in e){var i=e[o];if("$ref"===o&&"string"==typeof i){if(0!==i.indexOf("http://")&&0!==i.indexOf("https://")){var t=!0;if(r){var s=r.slice(-1);if("/"!==s&&0!==i.indexOf("#")&&0!==i.indexOf("http://")&&i.indexOf("https://")){console.log("working with "+i),t=!1;var n=r.split("/");n=n.splice(0,n.length-1),r="";for(var l=0;l<n.length;l++)r+=n[l]+"/"}}0!==i.indexOf("#")&&t&&(i="#"+i),i=(r||"")+i,e[o]=i}}else _.isObject(i)&&this.retainRoot(i,r)}return e},Resolver.prototype.resolveInline=function(e,r,o,i,t,s){var n,l,f,a,p=o.$ref,h=o.$ref,v=!1;if(h){if(0===h.indexOf("../")){for(l=h.split("../"),f=e.split("/"),h="",n=0;n<l.length;n++)""===l[n]?f=f.slice(0,f.length-1):h+=l[n];for(e="",n=0;n<f.length-1;n++)n>0&&(e+="/"),e+=f[n];v=!0}if(h.indexOf("#")>=0)if(0===h.indexOf("/"))a=h.split("#"),l=e.split("//"),f=l[1].split("/"),e=l[0]+"//"+f[0]+a[0],s=a[1];else{if(a=h.split("#"),""!==a[0]){if(f=e.split("/"),f=f.slice(0,f.length-1),!v){e="";for(var c=0;c<f.length;c++)c>0&&(e+="/"),e+=f[c]}e+="/"+h.split("#")[0]}s=a[1]}0===h.indexOf("http")?(h.indexOf("#")>=0?(e=h.split("#")[0],s=h.split("#")[1]):(e=h,s=""),i.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})):0===h.indexOf("#")?(s=h.split("#")[1],i.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})):i.push({obj:o,resolveAs:"inline",root:e,key:p,location:s})}else"array"===o.type&&this.resolveTo(e,o.items,i,s)},Resolver.prototype.resolveTo=function(e,r,o,i){var t,s,n=r.$ref,l=e;if("undefined"!=typeof n&&null!==n){if(n.indexOf("#")>=0){var f=n.split("#");if(f[0]&&0===n.indexOf("/"));else if(f[0]&&0===f[0].indexOf("http"))l=f[0],n=f[1];else if(f[0]&&f[0].length>0){for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=f[0]}i=f[1]}else if(0===n.indexOf("http://")||0===n.indexOf("https://"))l=n,i="";else{for(t=e.split("/"),l="",s=0;s<t.length-1;s++)l+=t[s]+"/";l+=n,i=""}o.push({obj:r,resolveAs:"ref",root:l,key:n,location:i})}else if("array"===r.type){var a=r.items;this.resolveTo(e,a,o,i)}else if(r&&r.properties){var p=this.uniqueName("inline_model");this.spec.definitions[p]=_.cloneDeep(r),r.$ref="#/definitions/"+p,delete r.type,delete r.properties}},Resolver.prototype.uniqueName=function(e){for(var r=e,o=0;;){if(!_.isObject(this.spec.definitions[r]))return r;r=e+"_"+o,o++}},Resolver.prototype.resolveAllOf=function(e,r,o){o=o||0,r=r||e;var i;for(var t in r)if(r.hasOwnProperty(t)){var s=r[t];if(null===s)throw new TypeError("Swagger 2.0 does not support null types ("+r+").  See https://github.com/swagger-api/swagger-spec/issues/229.");if("object"==typeof s&&this.resolveAllOf(e,s,o+1),s&&"undefined"!=typeof s.allOf){var n=s.allOf;if(_.isArray(n)){var l=_.cloneDeep(s);delete l.allOf,l["x-composed"]=!0,"undefined"!=typeof s["x-resolved-from"]&&(l["x-resolved-from"]=s["x-resolved-from"]);for(var f=0;f<n.length;f++){var a=n[f],p="self";"undefined"!=typeof a["x-resolved-from"]&&(p=a["x-resolved-from"][0]);for(var h in a)if(l.hasOwnProperty(h))if("properties"===h){var v=a[h];for(i in v){l.properties[i]=_.cloneDeep(v[i]);var c=v[i]["x-resolved-from"];("undefined"==typeof c||"self"===c)&&(c=p),l.properties[i]["x-resolved-from"]=c}}else if("required"===h){for(var d=l.required.concat(a[h]),u=0;u<d.length;++u)for(var g=u+1;g<d.length;++g)d[u]===d[g]&&d.splice(g--,1);l.required=d}else"x-resolved-from"===h&&l["x-resolved-from"].push(p);else if(l[h]=_.cloneDeep(a[h]),"properties"===h)for(i in l[h])l[h][i]["x-resolved-from"]=p}r[t]=l}}_.isObject(s)&&this.resolveAllOf(e,s,o+1)}};
